export const dict = {
  ...
  "prompt.popover.slashAria": "Slash command suggestions",
  "prompt.popover.thinkingAria": "Thinking variants",
  ...
  "prompt.action.enhance": "Enhance prompt with additional context",
  ...
  "prompt.codeIndex.title": "Code Index",
  "prompt.codeIndex.description": "Manage local code indexing and search options.",
  "prompt.codeIndex.section.status": "Status",
  "prompt.codeIndex.status.standby": "Standby",
  "prompt.codeIndex.status.indexing": "Indexing",
  "prompt.codeIndex.status.indexed": "Indexed",
  "prompt.codeIndex.status.error": "Index error",
  "prompt.codeIndex.meta.files": "Indexed files",
  "prompt.codeIndex.meta.lastIndexed": "Last indexed",
  "prompt.codeIndex.meta.workspace": "Workspace",
  "prompt.codeIndex.action.rebuild": "Rebuild now",
  "prompt.codeIndex.action.clear": "Clear index",
  "prompt.codeIndex.action.search": "Semantic search",
  "prompt.codeIndex.action.settings": "Settings",
  "prompt.action.voiceStart": "Start voice input",
  "prompt.action.voiceStop": "Stop voice input",
  "prompt.action.send": "Send",
  "prompt.action.stop": "Stop",
  "prompt.meta.rules": "Rules",
  "prompt.meta.feedback": "Feedback",
  "prompt.thinking.off": "Thinking: off",
  "prompt.thinking.label": "Thinking: {{variant}}",
  ...
  "prompt.toast.enhancePromptFailed": "Failed to enhance prompt",
  ...
  "settings.providers.enterprisePolicy.note":
    "Organization policy is enforcing provider allowlists. Some providers or models may be restricted.",
  "settings.providers.catalog.modelsCount": "{{count}} models",
  "settings.providers.catalog.defaultModel": "default: {{model}}",
  "settings.providers.catalog.policyModels": "Policy models: {{models}}",
  "settings.providers.catalog.policyBlocked": "Blocked by organization policy",
  "settings.providers.catalog.diagnostic.ok": "OK",
  "settings.providers.catalog.diagnostic.error": "Error",
  "settings.providers.catalog.diagnostic.history": "Diagnostics history",
  "settings.providers.catalog.diagnostic.empty": "No diagnostics recorded yet.",
  "settings.providers.action.test.button": "Test",
  "settings.providers.action.test.tooltip": "Run provider connection check",
  "settings.providers.action.copy.button": "Copy",
  "settings.providers.action.copy.tooltip": "Copy provider diagnostics",
  "settings.providers.action.connect.button": "Connect",
  "settings.providers.action.connect.tooltip": "Connect provider",
  "settings.providers.action.disconnect.button": "Disconnect",
  "settings.providers.action.disconnect.tooltip": "Disconnect provider",
  "settings.providers.connection.toast.diagnosticsCopied": "Provider diagnostics copied",
  "settings.providers.connection.toast.diagnosticsCopyFailed": "Failed to copy provider diagnostics",
  "settings.providers.connection.check.connected": "Connection check requested (refreshing provider catalog)",
  "settings.providers.connection.check.disconnected": "Connection check requested (connect flow)",
  "settings.providers.connection.report.connected": "Provider reported connected by backend",
  "settings.providers.connection.report.disconnected": "Provider reported disconnected by backend",
  "settings.providers.connection.auth.connected": "Connected successfully through provider auth flow",
  "settings.providers.connection.auth.disconnected": "Disconnected successfully",
  "settings.providers.connection.auth.failed": "Connection failed",
  "settings.providers.connection.toast.connected": "Provider connected",
  "settings.providers.connection.toast.disconnected": "Provider disconnected",
  "settings.providers.connection.toast.connectFailed": "Provider connect failed",
  "settings.providers.connection.toast.disconnectFailed": "Provider disconnect failed",
  "settings.providers.time.secondsAgo": "{{value}}s ago",
  "settings.providers.time.minutesAgo": "{{value}}m ago",
  "settings.providers.time.hoursAgo": "{{value}}h ago",
  "settings.providers.model.default.label": "Default Model",
  "settings.providers.model.default.description": "Primary model for conversations",
  "settings.providers.model.small.label": "Small Model",
  "settings.providers.model.small.description": "Lightweight model for title generation and other quick tasks",
  "settings.providers.model.clearLabel": "Not set (use server default)",
  "settings.providers.startup.label": "Startup Model (New Sessions)",
  "settings.providers.startup.description": "Default model preselected when you open a new chat session",
  "settings.providers.startup.preferGateway.label": "Prefer Kilo Gateway Default",
  "settings.providers.startup.preferGateway.description":
    "When enabled, startup model automatically follows the backend Kilo Gateway default.",
  "settings.providers.startup.useGateway.label": "Use Kilo Gateway Default",
  "settings.providers.startup.useGateway.description": "Pin startup model to the backend default model for Kilo Gateway",
  "settings.providers.startup.useGateway.tooltip": "Use the default model exposed by the Kilo Gateway provider",
  "settings.providers.startup.useGateway.button": "Use {{model}}",
  "settings.providers.startup.useGateway.none": "No gateway default",
  "settings.providers.startup.toast.updated": "Startup model updated",
  "settings.providers.custom.policyLocked":
    "Custom provider editing is disabled while organization allowlist policy is active.",
  "settings.providers.disabled.title": "Disabled Providers",
  "settings.providers.disabled.description": "Providers to hide from the provider list",
  "settings.providers.disabled.addTooltip": "Add selected provider to hidden list",
  "settings.providers.enabled.title": "Enabled Providers (Allowlist)",
  "settings.providers.enabled.description": "If set, only these providers will be available (exclusive allowlist)",
  "settings.providers.enabled.addTooltip": "Add selected provider to allowlist",
  "settings.providers.list.searchPlaceholder": "Search providers",
  "settings.providers.list.searchAria": "Search providers",
  "settings.providers.list.selectPlaceholder": "Select provider…",
  "settings.providers.list.add": "Add",
  "settings.providers.custom.title": "Custom Provider Configuration",
  "settings.providers.custom.description":
    "Configure custom providers in `config.provider`. Supports provider metadata, runtime options, allow/deny lists, and per-model overrides JSON.",
  "settings.providers.custom.toast.invalid": "Invalid provider configuration",
  "settings.providers.custom.toast.added": "Provider added",
  "settings.providers.custom.toast.updated": "Provider updated",
  "settings.providers.custom.toast.removed": "Provider removed",
  "settings.providers.custom.field.id": "Provider ID (required)",
  "settings.providers.custom.field.name": "Display name (optional)",
  "settings.providers.custom.field.api": 'Adapter API name (optional, e.g. "openai")',
  "settings.providers.custom.field.npm": 'NPM package (optional, e.g. "@ai-sdk/openai-compatible")',
  "settings.providers.custom.field.apiKey": "API key (optional)",
  "settings.providers.custom.field.baseUrl": "Base URL (optional)",
  "settings.providers.custom.field.enterpriseUrl": "Enterprise URL (optional)",
  "settings.providers.custom.field.timeout": "Request timeout in ms (optional)",
  "settings.providers.custom.field.setCacheKey": 'setCacheKey (optional: "true" or "false")',
  "settings.providers.custom.field.env": "Environment vars list (optional, one per line or comma-separated)",
  "settings.providers.custom.field.allow": "Model allowlist (optional, one per line or comma-separated)",
  "settings.providers.custom.field.deny": "Model denylist (optional, one per line or comma-separated)",
  "settings.providers.custom.field.modelsJson": "Models JSON (optional object)",
  "settings.providers.custom.field.optionsJson": "Extra options JSON (optional object)",
  "settings.providers.custom.action.cancelTooltip": "Cancel provider editing",
  "settings.providers.custom.action.saveTooltip": "Save provider changes",
  "settings.providers.custom.action.addTooltip": "Add custom provider",
  "settings.providers.custom.action.update": "Update Provider",
  "settings.providers.custom.action.add": "Add Provider",
  "settings.providers.custom.action.editTooltip": "Edit provider",
  "settings.providers.custom.summary.name": "name",
  "settings.providers.custom.summary.api": "api",
  "settings.providers.custom.summary.base": "base",
  "settings.providers.custom.summary.apiKey": "api_key",
  "settings.providers.custom.summary.allow": "allow",
  "settings.providers.custom.summary.deny": "deny",
  ...
  "session.history.status.refreshing": "Refreshing session history from CLI storage...",
  "session.history.status.error": "History refresh error: {{error}}",
  "session.history.status.syncedAt": "History synced at {{time}}",
  "session.history.status.sourceBackend": "Session history is sourced from the CLI backend.",
  "session.history.empty.fromCli":
    "No sessions returned by CLI storage yet. If you expected prior history after restart, click Refresh.",
  "session.history.toast.copyId.success": "Session ID copied",
  "session.history.toast.copyId.failed": "Failed to copy session ID",
  "session.history.deleteSelected.title": "Delete selected sessions",
  "session.history.deleteSelected.confirm": "Delete {{count}} selected sessions?",
  "session.history.context.resume": "Resume",
  "session.history.context.copyId": "Copy Session ID",
  "session.history.controls.filters": "Filters",
  "session.history.controls.select": "Select",
  "session.history.filters.workspace": "Workspace",
  "session.history.filters.workspace.current": "Current",
  "session.history.filters.workspace.all": "All",
  "session.history.filters.time.all": "All",
  "session.history.filters.sort": "Sort",
  "session.history.filters.favoritesOnly": "Favorites only",
  "session.history.favorites.add": "Add to favorites",
  "session.history.favorites.remove": "Remove from favorites",
  "session.history.favorites.mark": "Mark favorite",
  "session.history.filters.changedOnly": "Changed sessions only",
  "session.history.filters.showingChanged": "Showing changed sessions",
  "session.history.selection.selectVisible": "Select visible",
  "session.history.selection.deselectVisible": "Deselect visible",
  "session.history.selection.summary": "{{selected}} selected ({{visibleSelected}}/{{visible}} visible)",
  "session.history.selection.clear": "Clear",
  "session.history.sort.newest": "Newest",
  "session.history.sort.oldest": "Oldest",
  "session.history.sort.mostExpensive": "Most expensive",
  "session.history.sort.mostTokens": "Most tokens",
  "session.history.sort.mostRelevant": "Most relevant",
  "session.history.meta.duration": "Session duration",
  "session.history.meta.cost": "Session cost",
  "session.history.meta.changedFiles": "Changed files",
  "session.history.meta.lineChanges": "Line changes",
  "session.history.meta.filesCount": "{{count}} files",
  ...
  "marketplace.tab.mode": "Modes",
  "marketplace.tab.skill": "Skills",
  "marketplace.description.mcp": "Browse MCP servers for tools, integrations, and workflows.",
  "marketplace.description.mode": "Browse reusable agent modes and install them in one click.",
  "marketplace.description.skill": "Browse shared skills and install them locally or globally.",
  "marketplace.loading.short": "Loading...",
  "marketplace.loading.catalog": "Loading marketplace catalog...",
  "marketplace.results": "{{tab}} results: {{count}}",
  "marketplace.search.placeholder": "Search {{tab}} marketplace...",
  "marketplace.search.aria": "Search {{tab}} marketplace",
  "marketplace.filter.install": "Install filter",
  "marketplace.filter.install.all": "All items",
  "marketplace.filter.install.installed": "Installed",
  "marketplace.filter.install.notInstalled": "Not installed",
  "marketplace.filter.sort": "Sort",
  "marketplace.filter.sort.name": "Name",
  "marketplace.filter.sort.installedFirst": "Installed first",
  "marketplace.filter.clear": "Clear filters",
  "marketplace.notice.mcp": "Need advanced MCP management? Open Settings and go to Agent Behaviour.",
  "marketplace.notice.mode": "Installed modes can be managed from Settings.",
  "marketplace.notice.openSettings": "Open Settings",
  "marketplace.empty.filtered": "No {{tab}} items available for the current filters.",
  "marketplace.section.organizationManaged.default": "Organization managed MCPs",
  "marketplace.section.organizationManaged.named": "{{organization}} managed MCPs",
  "marketplace.section.catalog": "Marketplace catalog",
  "marketplace.footer.issuePrompt": "Spot a Marketplace issue?",
  "marketplace.footer.issueAction": "Open issue template",
  "marketplace.status.actionFailed": "Failed to {{action}} marketplace item",
  "marketplace.status.actionSucceeded": "Marketplace {{action}} succeeded",
  "marketplace.status.missingRequired": "Missing required fields: {{fields}}",
  "marketplace.itemType.mcp": "MCP server",
  "marketplace.itemType.mode": "mode",
  "marketplace.itemType.skill": "skill",
  "marketplace.target.project": "project",
  "marketplace.target.global": "global",
  "marketplace.confirm.remove": "Remove {{subject}} \"{{label}}\" from {{target}}?",
  "marketplace.card.byAuthor": "by {{author}}",
  "marketplace.card.viewAuthor": "View author profile",
  "marketplace.card.installed.project": "Project installed",
  "marketplace.card.installed.global": "Global installed",
  "marketplace.card.managedBy.organization": "Organization managed",
  "marketplace.card.managedBy.organizationNamed": "Managed by {{organization}}",
  "marketplace.card.details": "Details",
  "marketplace.card.prerequisites": "Prerequisites",
  "marketplace.card.installationMethod": "Installation method",
  "marketplace.card.managedNotice.default": "This item is managed by your organization.",
  "marketplace.card.managedNotice.named": "This item is managed by {{organization}}.",
  "marketplace.action.installing": "Installing...",
  "marketplace.action.removing": "Removing...",
  "marketplace.action.installProject": "Install Project",
  "marketplace.action.removeProject": "Remove Project",
  "marketplace.action.installGlobal": "Install Global",
  "marketplace.action.removeGlobal": "Remove Global",
  ...
  "settings.slashCommands.title": "Slash Commands",
  ...
  "settings.status.autoSaved": "Settings are saved automatically",
  ...
  "prompt.attachment.copyMarkdown": "Copy Markdown",
  ...
  "settings.language.selected": "Selected: {{value}}",
